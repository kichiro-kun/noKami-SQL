...
---------------------------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------------------------
    # Инициализация представления базы данных
    ...
    # Инициализация адаптера соединения (Требуемой СУБД)
    ...
    # инициализация менеджера для управления одиночным соединением
    ...
    # ---------------------------------------------------------------------------------------
    # Закрепление менеджера соединением
    ...
    # ---------------------------------------------------------------------------------------
    # Назначение новой конфигурации для БД
